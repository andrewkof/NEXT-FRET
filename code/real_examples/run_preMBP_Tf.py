...
initial_means       = [0.63, 0.84, 0.31, 0.46]
...
PriorMu2 = [2, 0.84, 2+1e-5]
PriorStd2 = [2, 0.08, samples**(0.5)]

PriorMu3 = [3, 0.31, 2+1e-5]
PriorStd3 = [3, 0.06, samples**(1)]

PriorMu4 = [4, 0.46, 2+1e-5]
